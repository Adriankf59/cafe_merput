...
const menuItems: MenuItem[] = [
  ...
  { icon: <Package size={20} />, label: 'Pemesanan Bahan', href: '/dashboard/pemesanan-bahan' },
  { icon: <ClipboardList size={20} />, label: 'Penerimaan Stok', href: '/dashboard/penerimaan-stok' },
  { icon: <Coffee size={20} />, label: 'Data Produk', href: '/dashboard/produk' },
  { icon: <Boxes size={20} />, label: 'Data Bahan Baku', href: '/dashboard/bahan-baku' },
];
